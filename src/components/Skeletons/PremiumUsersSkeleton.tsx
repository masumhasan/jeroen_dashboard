  ...
  <>
    <style>{`
      ...
      .pu-shimmer {
        ...
        animation: pu-shimmer 1.8s ease-in-out infinite;
      }
    `}</style>
    <div className={`pu-shimmer rounded-lg ${className ?? ""}`} style={style} />
  </>
);
  ...
  <tr style={{ borderBottom: "1px solid #f9fafb", opacity: 1 - index * 0.07 }}>
    ...
    <td className="py-3.5 px-4">
      <div className="space-y-1.5">
        ...
        <Shimmer style={{ width: 36, height: 10, borderRadius: 6 }} />
      </div>
    </td>
  </tr>
);

const PremiumUsersSkeleton: React.FC = () => (
  <div className="min-h-screen p-6 space-y-5" style={{ background: "#ffffff" }}>
    <div className="flex flex-col gap-2">
      <Shimmer style={{ width: 180, height: 24, borderRadius: 8 }} />
...
export default PremiumUsersSkeleton;
