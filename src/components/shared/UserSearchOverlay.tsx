...
import type { UserStatus } from "@/services/hooks/useGetUserManagement";
...
const StatusDot = ({ status }: { status: UserStatus }) => (
  <span
    className="flex items-center gap-1.5 text-[11px] font-semibold capitalize"
    style={{ color: status === "active" ? "#10b981" : "rgba(255,255,255,0.3)" }}
  >
    <span
      className="w-1.5 h-1.5 rounded-full inline-block"
      style={{
        background: status === "active" ? "#10b981" : "rgba(255,255,255,0.2)",
      }}
    />
    {status}
  </span>
...
const UserSearchOverlay: React.FC<UserSearchOverlayProps> = ({
  search,
  users,
  totalResults,
  isLoading,
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 24px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(137, 149, 127, 0.08)",
        }}
      >
        {/* Top accent */}
        <div
