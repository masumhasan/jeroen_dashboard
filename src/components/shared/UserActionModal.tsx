  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: "#fff",
          border: `1px solid ${isBlock ? "rgba(239,68,68,0.2)" : "rgba(16,185,129,0.2)"}`,
          boxShadow: `0 24px 60px rgba(0,0,0,0.15), 0 0 0 1px ${isBlock ? "rgba(239,68,68,0.08)" : "rgba(16,185,129,0.08)"}`,
        }}
      >
        {/* Top accent */}
        <div
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-3">
          <div className="flex items-center gap-2.5">
            ...
            <span
              ...
              style={{ color: isBlock ? "#ef4444" : "#10b981" }}
            >
              {isBlock ? "Are you sure !" : "User Accept"}
            </span>
          </div>
          <button
            onClick={!isActing ? onClose : undefined}
        ...
        <div className="px-5 pb-2 text-center">
          <p className="text-sm" style={{ color: "#374151" }}>
            {isBlock
              ? `Do you want to Block ${user.name}'s profile ?`
              : `Are you sure Unblock this User Profile ?`}
          </p>
        </div>
